...
<div class="form-horizontal">
  <div class="form-group">
    ...
    <div class="col-sm-8 error_block">
      <input class="form-control" name="stock_code" id="stock_code" value="<?php echo $billing_data->stock_code; ?>" placeholder="Stock Code" type="text" required="">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8 error_block">
      <input class="form-control" name="billing_uom" id="billing_uom" value="<?php echo $billing_data->billing_uom; ?>" placeholder="UOM" type="text" required="">
    </div>
  </div>
  <div class="form-group">
    <label for="billing_price_per_uom" class="col-sm-2 control-label">Price Per UOM</label>
    <div class="col-sm-8 error_block">
      <input class="form-control" name="billing_price_per_uom" id="billing_price_per_uom" value="<?php echo $billing_data->billing_price_per_uom; ?>" placeholder="Price Per UOM" type="text" required="">
    </div>
  </div>
  <div class="form-group">
