        ...
        <div class="box-body with-border">
            <form class="form-horizontal validate" method="post" enctype="multipart/form-data" action="<?php echo $save_url; ?>" >
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8 error_block">
                  <input class="form-control" name="gst_reg_no" id="gst_reg_no"  value="<?php echo $company_details->gst_reg_no; ?>" placeholder="GST REG. No" type="text" required="" disabled="">
                </div>
              </div>
              <div class="form-group">
                <label for="uen_no" class="col-sm-2 control-label">UEN No.</label>
                <div class="col-sm-8 error_block">
                  <input class="form-control" name="uen_no" id="uen_no"  value="<?php echo $company_details->uen_no; ?>" placeholder="UEN No." type="text" required="" disabled="">
                </div>
              </div>
              <div class="form-group">
                <label for="company_address" class="col-sm-2 control-label">Company Address</label>
                <div class="col-sm-8 error_block">
                  <input class="form-control" name="company_address" id="company_address"  value="<?php echo $company_details->company_address; ?>" placeholder="Company Address" type="text" required="">
                </div>
              </div>
              <div class="form-group">
                <label for="phone" class="col-sm-2 control-label">Phone</label>
                <div class="col-sm-8 error_block">
                  <input class="form-control" name="phone" id="phone"  value="<?php echo $company_details->phone; ?>" placeholder="Phone" type="text" required="">
                </div>
              </div>
              <div class="form-group">
                <label for="fax" class="col-sm-2 control-label">FAX</label>
                <div class="col-sm-8 error_block">
                  <input class="form-control" name="fax" id="fax"  value="<?php echo $company_details->fax; ?>" placeholder="FAX" type="text" required="">
                </div>
              </div>
              <div class="form-group">
