...
<section class="content">
  ...
  <span class="tooltiptext">Tooltip text</span>
          ...
          <h3 class="box-title">Debtor Statement</h3>
        </div>
      </div>
    </div>
  </div>
...
$(function() {
  ...
  $("#customer_id").change(function(event) {
    ...
    if(customer_id!=""){
      $.post('<?php echo base_url('common/Ajax/account_ajax/get_customer_details_ar') ?>', {customer_id: customer_id}, function(data, textStatus, xhr) {
        console.log(data);
