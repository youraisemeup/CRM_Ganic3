<section class="content-header">
  <?php 
    $list = array('active'=>"Debtors' Listing by Currency type");
...
<section class="content">
  ...
  <span class="tooltiptext">Tooltip text</span>
          ...
          <h3 class="box-title">Debtors' Listing by Currency type</h3>
        </div>
      </div>
    </div>
  </div>
...
$(function() {
  $.post('<?php echo base_url('common/Ajax/account_ajax/get_usd_debtor') ?>', {currency_type: "-- Select Currency --"}, function(data, textStatus, xhr) {
           // alert(data);
  ...
  $("#currency_type").change(function(event) {
    ...
    //alert(currency_type);
    if(currency_type!=""){
      $.post('<?php echo base_url('common/Ajax/account_ajax/get_usd_debtor') ?>', {currency_type: currency_type}, function(data, textStatus, xhr) {
           // alert(data);
