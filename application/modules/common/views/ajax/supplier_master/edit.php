    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <div class="col-sm-8 error_block">
          <input class="form-control" name="customer_code" id="supplier_code" value="<?php echo $customer->customer_code; ?>"  placeholder="Customer Code" type="text" required="">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8 error_block">
          <input class="form-control" name="customer_name" id="customer_name" value="<?php echo $customer->customer_name; ?>"   placeholder="Customer Name" type="text" required="" data-rule-alphanumeric="true">
        </div>
      </div>
      <div class="form-group">
        <label for="customer_contact_person" class="col-sm-4 control-label">Contact Person : </label>
        <div class="col-sm-8 error_block">
          <input class="form-control" name="customer_contact_person" id="customer_contact_person" value="<?php echo $customer->customer_contact_person; ?>"   placeholder="Contact Person" type="text" data-rule-alphanumeric="true">
        </div>
      </div>
      <div class="form-group">
