<div class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8 error_block">
      <input class="form-control" name="gst_code" id="gst_code" value="<?php echo $gst->gst_code; ?>"  value="" placeholder="Code" type="text" required="">
    </div>
  </div>
  <div class="form-group">
    <label for="gst_rate" class="col-sm-2 control-label">GST Rate</label>
    <div class="col-sm-8 error_block">
      <input class="form-control" name="gst_rate" id="gst_rate" value="<?php echo $gst->gst_rate; ?>"  value="" placeholder=" Rate" type="number" required="" step="any"> 
    </div>
  </div>
  <div class="form-group">
