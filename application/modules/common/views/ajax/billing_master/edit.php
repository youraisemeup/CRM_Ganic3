...
<div class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8 error_block">
      <input class="form-control" name="billing_price_per_uom" id="billing_price_per_uom" value="<?php echo $billing_data->billing_price_per_uom; ?>" placeholder="Price Per UOM" type="number">
    </div>
  </div>
  <div class="form-group">
