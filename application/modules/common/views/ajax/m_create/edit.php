<div class="form-horizontal">
  <div class="form-group">
  	<input class="form-control" name="id" id="id" value="<?php echo $currency->currency_id ?>" placeholder="Group Name" type="hidden" required="">
    <label for="currency_name" class="col-sm-2 control-label">Currency Name</label>
    <div class="col-sm-8 error_block">
      <input class="form-control" name="currency_name" id="currency_name"  placeholder="Rate" value="<?php echo $currency->currency_name; ?>" type="text" required="">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8 error_block">
      <input class="form-control" name="currency_rate" id="currency_rate" value="<?php echo $currency->currency_rate; ?>" placeholder="Rate" type="number" required="">
    </div>
  </div>
  <div class="form-group">
    <label for="currency_description" class="col-sm-2 control-label">Description</label>
    <div class="col-sm-8 error_block">
      <input class="form-control" name="currency_description" value="<?php echo $currency->currency_description; ?>"  id="currency_description" placeholder=" Description" required="" type="text">
    </div>
  </div>
</div>
<?php 
