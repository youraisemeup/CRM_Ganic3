            ...
            <div class="col-md-12">
              ...
              <div class="box-body">
                <section class="invoice">
                  ...
                  <div class="row">
                    <div class="col-xs-12">
                      <textarea class="form-control" rows="1" name="quotation_header_text"><?php echo $quotation_edit_data->quotation_header_text; ?></textarea>
                    </div>
                  </div>
                  <br>
                  <!-- <legend></legend> -->
                          ...
                          <tbody>
                            ...
                            <tr>
                              <th style="width:50%">Lump Sum Discount (%):</th>
                               <td ><input type="number" min='0' max='100' value="<?php echo $quotation_edit_data->lump_sum_discount; ?>" id="lump_sum_discount" name="lump_sum_discount" class="form-control" onchange="get_sub_total()"></td>
                        ...
                        <table class="table">
                          ...
                          <?php if(!empty($quotation_edit_data->terms_of_payments)): ?>
                            <tr>
                              ...
                              <td><input type="" class="form-control" name="terms_of_payments" id="terms_of_payments" value="<?php echo $quotation_edit_data->terms_of_payments; ?>"></td>
                            </tr>
                          <?php endif; ?>
                            <?php if(!empty($quotation_edit_data->training_venue)): ?>
                            <tr>
                              <th style="width:30%">Training Venue:</th>
                              <td><input type="" class="form-control" name="training_venue" id="training_venue" value="<?php echo $quotation_edit_data->training_venue; ?>"></td>
                            </tr>
                          <?php endif; ?>
                            <?php if(!empty($quotation_edit_data->modification)): ?>
                            <tr>
                              <th style="width:30%">Modification:</th>
                              <td><input type="" class="form-control" name="modification" id="modification" value="<?php echo $quotation_edit_data->modification; ?>"></td>
                            </tr>
                          <?php endif; ?>
                            <?php if(!empty($quotation_edit_data->cancellation)): ?>
                            <tr>
                              <th style="width:30%">Cancellation:</th>
                              <td><input type="" class="form-control" name="cancellation" id="cancellation" value="<?php echo $quotation_edit_data->cancellation; ?>"></td>
                            </tr>
                          <?php endif; ?>
                            <tr>
                              <td colspan="2"><textarea class="form-control" rows="1" name="quotation_footer_text" id="quotation_footer_text" ><?php echo $quotation_edit_data->quotation_footer_text; ?></textarea></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
