                      ...
                      <table class="table table-striped" id="product_table">
                        <thead>
                          <tr>
                            ...
                            <th>QUANTITY</th>
                            <th>UOM</th>
                            <th width="15%">UNIT PRICE(<?php echo $customer_options->currency_name; ?>)</th>
                            <th>DISCOUNT (%)</th>
                          ...
                          <?php 
                            ...
                            for($i = 0; $i < $row_num; $i ++){
                              ...
                              <tr>
                                ...
                                <td><?php if (isset($unit_price[$i])) {
                                  echo $unit_price[$i];
                                } ?></td>
                                <td><?php if (isset($discount[$i])) {
                                  echo $discount[$i];
                                }  ?></td>
                                <td><?php if (isset($amount[$i])) {
                                  echo $amount[$i];
                                }?></td>
                                <td><?php echo $cat[$i]; ?></td>
                                <td><?php if (isset($gst_amt[$i])) {
                                  echo $gst_amt[$i];
                                } ?></td>
                              </tr>
                              <?php
                    ...
                    <div class="col-md-12 col-xs-12">
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <?php endif; ?>
                            <tr>
                              <td colspan="2"><?php echo $quotation_footer_text; ?></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
