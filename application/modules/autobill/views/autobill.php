              ...
              <div class="box-body">
                <section class="autobill">
                  ...
                  <div class="row autobill-info">
                    ...
                    <!-- /.col -->
                    <div class="col-sm-4 autobill-col">
                      <b>Reference : <?php echo $autobill_details->autobill_text_prefix.'.'.$total_autobill; ?></b><br>
                      <input type='hidden' name='autobill_ref_no' id="autobill_ref_no" value="<?php echo $autobill_details->autobill_text_prefix.'.'.$total_autobill; ?>">
                      <br>
                      <b>Bill Date: </b><input type='text' name='bill_date' class="bill_date" value="<?php echo date('Y-m-d');?>"><br> 
                    </div>
                    <!-- /.col -->
                  </div>
                  <!-- /.row -->
                    ...
                    <div class="col-md-6">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control start_date" onchange="set_enddate($(this).val())" name="start_date" id="start_date" placeholder="Enter Start Date">
                          </div>
                        </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <input type="text" name="end_date" readonly="" class="form-control end_date" id="end_date">
                          </div>
                        </div>
                      </div>
                    </div> 
                    ...
                    <div class="col-md-6 col-md-offset-6 col-xs-12">
                      <div class="table-responsive">
                        <table class="table hidden" id="summary">
                          <tbody>
                            <tr>
                              <th style="width:50%">Contract Sum <br>for period above(<span id="cust_curr">SGD</span>):</th>
                              <td class="hidden"><input type='hidden' name='contract_sum' id="contract_sum" value='0'></td>
                              <td></td>
                              <td id="contract_sum_text" class="pull-right">0</td>
                            </tr>
                            <tr>
                              <th>Less <br> Discount (%):</th>
                              <td ><input type="number" min='0' max='100' id="less_discount" name="less_discount" class="form-control" onchange="get_inclusive_gst()"></td>
                              <td id="less_discount" class="hidden"></td>
                              <td id="less_discount_amount_display" class="pull-right"></td>
                            </tr>
                            <tr>
                              <th>Net<br> Contract Amount:</th>
                              <td></td>
                              <td id="net_contract_amount_text" class="pull-right"></td>
                              <td class="hidden"><input type='hidden' name='net_contract_amount' id="net_contract_amount"></td>
                            </tr>
                            <tr>
                              <th>GST (%) :</th>
                            ...
                            <tr>
                              ...
                              <td></td>
                              <td id="total_inclusive_gst_text" class="pull-right"></td>
                              <td class="hidden"><input type='hidden' name='total_inclusive_gst' id="total_inclusive_gst"></td>
                            </tr>
                            <tr id="total_curr" >
                              <th>Total in(<span id="cust_curr">SGD</span>):</th>
                              <td></td>
                              <td id="total_inclusive_gst_local_text" class="pull-right"></td>
                              <td class="hidden"><input type='hidden' name='currency_amount' id="currency_amount"></td>
                              <td class="hidden"><input type='hidden' name='total_inclusive_gst_local' id="total_inclusive_gst_local"></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
...
$(function() {
  ...
  var save_form_action = '<?php echo base_url('autobill/create_new_autobill');?>';
