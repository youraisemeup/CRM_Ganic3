<section class="content-header">
  ...
  {
  echo "Confirmed Stock Purchases";
  }
  else
  echo ucwords($this->uri->segment(3))." Stock Purchases";
  ...
  if($this->uri->segment(3)=="confirm")
  { 
    $list = array('active'=>ucwords('Confirmed Stock Purchases'));   
  }
  else
  {
      $list = array('active'=>ucwords($this->uri->segment(3)).' Stock Purchases');
  }
...
//    var print_flag = true;
    ...
    "ajax": {
      "url": "<?php echo base_url('common/datatable/ajax_list/stock_purchase_list/').$this->uri->segment(3); ?>",
      "type": "POST"
    },
    ...
    /* delete button */  
     $("#delete").on('click',function(){
      var url = '<?php echo base_url()."common/Ajax/stock_openlist_ajax/delete_purchase" ?>';
        showData("delete",url);
     });
     /*... over here ...*/
     ...
     $("#success").on('click',function(){// during the post button clicking
        var url = '<?php echo base_url()."common/Ajax/stock_openlist_ajax/post_purchase" ?>';
     ...
     $("#edit").on('click',function(){
        var url = '<?php echo base_url()."stock/stock_purchase_manage/edit/" ?>';
        showData("stock_purchase_edit",url);
     });
     /*... over here ...*/
