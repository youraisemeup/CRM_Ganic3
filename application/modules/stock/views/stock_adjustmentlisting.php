<section class="content-header">
  ...
  {
  echo "Confirmed Stock Adjustment";
  }
  else
  echo ucwords($this->uri->segment(3))." Stock Adjustment";
  ...
  if($this->uri->segment(3)=="confirm")
  { 
    $list = array('active'=>ucwords('Confirmed Stock Adjustment'));   
  }
  else
  {
      $list = array('active'=>ucwords($this->uri->segment(3)).' Stock Adjustment');
  }
...
//    var print_flag = true;
    ...
    "ajax": {
      "url": "<?php echo base_url('common/datatable/ajax_list/stock_adjustment_list/').$this->uri->segment(3); ?>",
      "type": "POST"
    },
    ...
    /* delete button */  
     $("#delete").on('click',function(){
      var url = '<?php echo base_url()."common/Ajax/stock_openlist_ajax/delete_adjustment" ?>';
        showData("delete",url);
     });
     /*... over here ...*/
     ...
     $("#success_all").on('click',function(){// during the post button clicking
        ...
        var url = '<?php echo base_url()."common/Ajax/stock_openlist_ajax/post_adjustment" ?>';
        table.rows().select();
     ...
     $("#edit").on('click',function(){
        var url = '<?php echo base_url()."stock/stock_adjustment_manage/edit/" ?>';
        showData("stock_adjustment_edit",url);
     });
     /*... over here ...*/
