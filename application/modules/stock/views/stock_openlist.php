<section class="content-header">
  ...
  {
  echo "Confirmed Stock Opening Balance";
  }
  else
  echo ucwords($this->uri->segment(3))." Stock Opening Balance";
  ...
  if($this->uri->segment(3)=="confirm")
  { 
    $list = array('active'=>ucwords('Confirmed Stock Opening Balance'));   
  }
  else
  {
      $list = array('active'=>ucwords($this->uri->segment(3)).'Stock Opening Balance');
  }
...
//    var print_flag = true;
    ...
    /* delete button */  
     $("#delete").on('click',function(){
      var url = '<?php echo base_url()."common/Ajax/stock_openlist_ajax/delete_open" ?>';
        showData("delete",url);
     });
     /*... over here ...*/
     ...
     $("#success").on('click',function(){// during the post button clicking
        ...
        var url = '<?php echo base_url()."common/Ajax/stock_openlist_ajax/post_open" ?>';
     ...
     $("#edit").on('click',function(){
        var url = '<?php echo base_url()."stock/stock_open_manage/edit/" ?>';
