                ...
                <section class="invoice">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="col-md-4 form-group error_block">
                        <input type="text" name="doc_date" class="doc_date form-control" required="">   
                      </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-md-4 form-group error_block">
                        <input type="text" name="purchase_ref_no" class="form-control" required="" value="">
                      </div>
                      <div class="col-md-5"></div>  
                    </div>
                  </div>
                    ...
                    <!-- /.col -->
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="col-md-4 form-group error_block">
                            <input type="number" name="freight_insurance" required="" class="form-control" id="freight_insurance" onchange="get_sub_total();">
                          </div>
                      ...
                      <div class="row">
                        <div class="col-md-6" id="xchange_part">
                          ...
                          <div class="col-md-4 form-group error_block">
                            <input type='number' class="form-control" name='currency_amount' required="" value="1" onchange="get_sub_total();" id="xchange_rate">
                          </div>
                          <div class="col-md-3"></div>
                        </div>
                        <div class="col-md-6">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="col-md-4 form-group error_block">
                            <input type="number" name="local_handling" required="" class="form-control" onchange="get_sub_total();" id="local_handling">  
                          </div>
                          <div class="col-md-3"></div>
                        </div>
                        <div class="col-md-6">
                  ...
                  <div class="col-md-6 col-md-offset-6 col-xs-12 pull-right">
                      ...
                      <div class="pull-right hidden" id="GST_btn">
                        ...
                        <button type="button" class="btn btn-primary" onclick="$('#GST_btn').hide();$('#input_GST').removeClass('hidden');$('#submitbtn').removeClass('hidden');$('$freight_insurance').focus().val('');">Yes</button>
                        <!-- <button type="button" class="btn btn-primary " onclick='$("#product_id").select2("open");'>No</button> -->
                  ...
                  <div class="col-md-6 col-md-offset-6 col-xs-12 hidden pull-right" id="input_GST">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <input type="number" name="gst_in_sgd" class="form-control">
                      </div>
                    </div>
                  </div>
      ...
      $.post('<?php echo base_url('common/Ajax/backend_ajax/get_customer_details') ?>', {customer_id: customer_id}, function(data, textStatus, xhr) {
        ...
        if(obj.customer_currency!="SGD"){
          $("#total_curr").removeClass('hidden');
            $(".customer_currency_unit").html(obj.customer_currency);
            $("#import_part").removeClass('hidden');
            $("#xchange_part").removeClass('hidden');
        }
        else{
          $("#total_curr").addClass('hidden');
          $("#xchange_part").addClass('hidden');
          $("#import_part").addClass('hidden');
          $("#GST_btn").addClass('hidden');
