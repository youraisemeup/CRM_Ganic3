<section class="content-header">
  ...
  {
  echo "Confirmed Bank Adjustment";
  }
  else
  echo ucwords($this->uri->segment(3))." Bank Adjustment";
  ...
  if($this->uri->segment(3)=="confirm")
  { 
    $list = array('active'=>ucwords('Confirmed Bank Adjustment'));   
  }
  else
  {
      $list = array('active'=>ucwords($this->uri->segment(3)).' Bank Adjustment');
  }
...
<script type="text/javascript">
  jQuery(document).ready(function() {
    ...
    "ajax": {
      "url": "<?php echo base_url('common/datatable/ajax_list/bank_ad_list/').$this->uri->segment(3); ?>",
      "type": "POST"
    },
    ...
    /* delete button */  
     $("#delete").on('click',function(){
      var url = '<?php echo base_url()."common/Ajax/bank_adlist_ajax/delete" ?>';
        showData("delete",url);
     });
     /*... over here ...*/
     ...
     $("#success").on('click',function(){// during the post button clicking
        var url = '<?php echo base_url()."common/Ajax/bank_adlist_ajax/postOpen" ?>';
     ...
     $("#edit").on('click',function(){
        var url = '<?php echo base_url()."backend/bank_adjustment_manage/edit/" ?>';
