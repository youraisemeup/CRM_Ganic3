                ...
                <section class="receipt">
                  ...
                  <div class="row receipt-info">
                    ...
                    <div class="col-sm-4 receipt-col">
                      ...
                      <br>
                      <b>Payment : <?php echo $payment_details->payment_text_prefix.'.'.$total_payment; ?></b><br>
                  ...
                  <div class="row">
                    <div class="col-xs-12 col-md-4 product_id_div">
                      <select name="purchase_reference_id" id="invoice_reference_id" title="Select Invoice reference" required="" class="form-control select2" multiple="multiple">
                  ...
                  <div class="row" align="left">
                    <div class="col-md-12">
                        <div class="display-none receipt_body">Paid to supplier with the sum of <span id="currency">...</span><span id="inv_amount">...</span> Net being payment as shown above<!--  with <span id="cn_amount">...</span> Debit Note.</div>                       -->
                    </div>
                    <br>
...
$(function() {
  ...
  var debit_tune = function(change_flag) { 
      ...
      if (tot_cn < tot_inv) {
        ...
        $("#rec_amount").val(tot_cn.toFixed(2));
