<section class="content-header">
  <?php 
    $list = array('active'=>"Credits' Listing by Currency type");
...
<section class="content">
  ...
  <span class="tooltiptext">Tooltip text</span>
          ...
          <h3 class="box-title">Credits' Listing by Currency type</h3>
        </div>
      </div>
    </div>
  </div>
                    ...
                    <div class="box-body">
                      <div class="table-responsive">
                        <table id="datatable" class="table table-fixed" width="100%">
                          ...
                          <thead>
                            <tr>
                              <th>code: xxxx, yyyyyyyyyy</th>
                              <th>Contact Person: zzzzzzzzzzzzz</th>
                              <th></th>
                              <th></th>
                              <th></th>
                              <th>tel: 23423423434</th>
                            </tr>
...
$(function() {
  $.post('<?php echo base_url('common/Ajax/backend_ajax/get_credit_list') ?>', {currency_type: "-- Select Currency --"}, function(data, textStatus, xhr) {
           // alert(data);
  ...
  $("#currency_type").change(function(event) {
    ...
    //alert(currency_type);
    if(currency_type!=""){
      $.post('<?php echo base_url('common/Ajax/backend_ajax/get_credit_list') ?>', {currency_type: currency_type}, function(data, textStatus, xhr) {
           // alert(data);
