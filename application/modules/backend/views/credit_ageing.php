<section class="content-header">
  <?php 
    $list = array('active'=>"Credits' Ageing by Currency type");
...
<section class="content">
  ...
  <span class="tooltiptext">Tooltip text</span>
          ...
          <h3 class="box-title">Credits' Ageing by Currency type</h3>
        </div>
      </div>
    </div>
  </div>
...
$(function() {
  $.post('<?php echo base_url('common/Ajax/backend_ajax/get_credit_ageing') ?>', {currency_type: "-- Select Currency --"}, function(data, textStatus, xhr) {
  ...
  $("#currency_type").change(function(event) {
    ...
    //alert(currency_type);
    if(currency_type!=""){
      $.post('<?php echo base_url('common/Ajax/backend_ajax/get_credit_ageing') ?>', {currency_type: currency_type}, function(data, textStatus, xhr) {
           // alert(data);
