<section class="content-header">
  <h1>
    <?php
  echo ucwords($this->uri->segment(3))."Historical Costing List";
...
<script type="text/javascript">
  jQuery(document).ready(function() {
    ...
    "ajax": {
      "url": "<?php echo base_url('common/datatable/ajax_list/histcostlist/').$this->uri->segment(3); ?>",
      "type": "POST"
    },
