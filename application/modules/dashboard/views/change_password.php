...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="box box-info">
      ...
      <!-- form start -->
            <form autocomplete="off"class="form-horizontal validate" method="post" action="<?php echo base_url('dashboard/change_password/save') ?>">
              <div class="form-group">
                <label for="identity" class="col-sm-2 control-label">Identity</label>
                <div class="col-sm-8 error_block">
                  <select name="identity" id="identity" title="Select Admin Identity" class="form-control select2" required="">
