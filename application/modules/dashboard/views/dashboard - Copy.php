<style type="text/css">
  #system_managers_menu,#applications_menu,#backends_menu,#system_utilities_menu,#master_files_menu,#staff_managment_menu,#combo_tables_menu,#quotations_menu,#invoices_menu,#receipts_menu,#account_receivable_menu, #account_receivable_menu2, #stock_menu, #managements_menu{
    display: none;
  }
</style>
...
<?php }  ?>   
  ...
  $("#system_utilities_menu,#master_files_menu,#staff_managment_menu,#combo_tables_menu,#quotations_menu,#invoices_menu,#receipts_menu,#account_receivable_menu, #account_receivable_menu2,#stock_menu,#managements_menu").hide();
    ...
    if(i == 1){
      ...
      $("#system_utilities,#master_files,#staff_managment,#combo_tables,#quotations,#invoices,#receipts,#account_receivable,#stock,#managements").click(function() {
        if(i == 2){
          
          $("#system_utilities_menu,#master_files_menu,#staff_managment_menu,#combo_tables_menu,#quotations_menu,#invoices_menu,#receipts_menu,#account_receivable_menu,#account_receivable_menu2,#stock_menu,#managements_menu").slideUp();
          id=$(this).attr('id');
          $("#"+id+"_menu").slideDown();
          $("#"+id+"_menu2").slideDown();
          $("html, body").delay(1000).animate({
