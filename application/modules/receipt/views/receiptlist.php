<section class="content-header">
  <div class="row">
    <div class="col-md-3">
      <h2>
        <?php echo ucwords($this->uri->segment(3)); ?> Receipt
  ...
  <?php 
    $list = array('active'=>ucwords($this->uri->segment(3)).' Receipt ');
  ...
  jQuery(document).ready(function() {
    ...
    /* delete button */
     $("#delete").on('click',function(){
      var url = '<?php echo base_url()."common/Ajax/receiptlist_ajax/deleted" ?>';
        showData("delete",url);
     });
     /*... over here ...*/
