<section class="content-header">
  ...
  <?php 
    $list = array('active'=>'Supplier Master');
...
<script type="text/javascript">
  jQuery(document).ready(function() {
    ...
    "ajax": {
      "url": "<?php echo base_url('common/datatable/ajax_list/supplier_master'); ?>",
      "type": "POST"
    },
    ...
    { 
     ...
     $("#save").on('click',function(){
        ...
        var valid = $('.supplier_code_error').css('display');
        if(form.valid())
        {
          if (valid != 'block') {
            form.submit();  
