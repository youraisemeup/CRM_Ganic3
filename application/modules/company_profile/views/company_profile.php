      ...
      <div class="row">
        <div class="col-md-8 col-md-offset-2">
          ...
          <div class="box-body">
            ...
            <?php if($company_details->gst_reg_no != ''):?>
            <br>GST Register Number : <?php echo $company_details->gst_reg_no; ?>
            <?php endif;?>
            <?php if($company_details->uen_no != ''):?>
            ...
            <br>Email : <?php echo $company_details->company_email; ?>
          </div>
          </center></strong>
        </div>
      </div>
