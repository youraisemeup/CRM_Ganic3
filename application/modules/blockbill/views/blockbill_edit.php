...
<section class="content">
  ...
  <form autocomplete="off" id="form_" class="form-horizontal validate" method="post" action="<?php echo $save_url; ?>">
  	<input type="hidden" name="blockbill_id" value="<?php echo $blockbill_edit_data->blockbill_id; ?>">
    <input type="hidden" id="next_bill_date" name="next_bill_date" value="<?php echo $blockbill_edit_data->next_bill_date; ?>">
    <div class="row">
      <div class="col-md-12">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box-header with-border">
                ...
                <hr>
              <div class="box-body">
                <section class="blockbill">
                  <!-- info row -->
                  <div class="row blockbill-info">
                    <div class="col-sm-4 blockbill-col">
                      <b>To,</b>
                      <address>
                    ...
                    <div class="col-sm-4 blockbill-col">
                      ...
                      <input type='hidden' name='blockbill_ref_no' id="blockbill_ref_no" value="<?php echo $blockbill_edit_data->blockbill_ref_no; ?>">
                      <br>
                      <b>Bill Date: </b><input type='text' name='bill_date' class="bill_date" value="<?php echo $blockbill_edit_data->bill_date;?>"><br> 
                    </div>
                    <!-- /.col -->
                  </div>
                  <!-- /.row -->
                    ...
                    <div class="col-md-6">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control start_date" onchange="set_enddate($(this).val())" name="start_date" id="start_date" placeholder="Enter Start Date" value="<?php echo $blockbill_edit_data->start_date;?>">
                          </div>
                        </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                            <input type="text" name="end_date" readonly="" class="form-control end_date" id="end_date" value="<?php echo $blockbill_edit_data->end_date;?>">
                          </div>
                        </div>
                      </div>
                    </div> 
                        ...
                        <table class="table hidden" id="summary">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td ><input type="number" min='0' max='100' id="less_discount" name="less_discount" class="form-control" onchange="get_inclusive_gst()" value="<?php echo $blockbill_edit_data->less_discount;?>"></td>
...
<script type="text/javascript" src="<?php echo JS_PATH ?>blockbill.js"></script>
...
$(function() {
  ...
  // var print_form_action = '<?php echo base_url('common/Ajax/blockbilllist_ajax/print_new_autobill');?>';
  var save_form_action = '<?php echo base_url('blockbill/create_new_blockbill/edit');?>';
    ...
    $('form#form_').submit(function(){
      if ($print == false) {
         ...
         if ($cansend == true)
            ...
            $('#quot_status').html('');
            $.confirm({
                title:"<i class='fa fa-info'></i> Blockbill Confirmation",
                text: "Confirm?",
                cancelButton: "No",
                confirm: function(button) {
                  $('#quot_status').html('');
  ...
  contract_id='<?php echo $blockbill_edit_data->contract_id; ?>';
  contract_edit_currency = '<?php echo $blockbill_edit_data->currency_amount;?>';
  	if(contract_id!=""){

		$.post('<?php echo base_url('common/Ajax/blockbilllist_ajax/get_contract_details') ?>', {contract_id: contract_id}, function(data, textStatus, xhr)
		{
  ...
  $("#customer_id").change(function(event) {
    ...
    if(customer_id!=""){
      $.post('<?php echo base_url('common/Ajax/blockbilllist_ajax/get_customer_details') ?>', {customer_id: customer_id}, function(data, textStatus, xhr) {
        var obj = $.parseJSON(data);
