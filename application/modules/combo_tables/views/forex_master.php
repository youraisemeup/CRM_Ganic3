<section class="content-header">
  ...
  <?php 
    $list = array('active'=>'Forex Master');
...
<script type="text/javascript">
  jQuery(document).ready(function() {
    ...
    "ajax": {
      "url": "<?php echo base_url('common/datatable/ajax_list/forex_master'); ?>",
      "type": "POST"
    },
    ...
    { 
     ...
     $("#save").on('click',function(){
        ...
        var valid = $('.currency_error').css('display');
        if(form.valid())
        {
          if (valid != 'block') {
            form.submit();  
