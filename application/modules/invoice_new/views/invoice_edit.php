...
$(function() {
  invoice_id='<?php echo $invoice_edit_data->invoice_id; ?>';
  var product_id_json='<?php echo json_encode($product_array); ?>';
      ...
      for (var i = 0; i < product_id_arr.length; i++) {
        ...
        $.post('<?php echo base_url('common/Ajax/invoicelist_ajax/get_product_row_edit') ?>', {  billing_id: product_id,invoice_id:invoice_id}, function(data, textStatus, xhr) {
