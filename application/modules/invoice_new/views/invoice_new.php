              ...
              <div class="box-body">
                <section class="invoice">
                  ...
                  <div class="row invoice-info">
                    ...
                    <!-- /.col -->
                    <div class="col-sm-4 invoice-col">
                      <b>Invoice : <?php echo $invoice_details->invoice_text_prefix.'.'.$total_invoice; ?></b>
                    ...
                    <div class="col-xs-12 col-md-12">
                     <!--  <div class="col-xs-6 "></div> -->
                      <div class="col-xs-12 col-md-8">
                        ...
                        <input type="hidden" name="logo_with" value="logo_without" id="logo_with">
...
$(function() {
  ...
  var save_form_action = '<?php echo base_url('invoice_new/create_new_invoice');?>';
  //=========================customer details ====================================================
  $cansend = false;
  $print = false;
  ...
  $('form#form_').submit(function(){
      if ($print == false) {
          ...
          if ($cansend == true)
            ...
            $('#quot_status').html('');
            $.confirm({
                title:"<i class='fa fa-info'></i> Invoice Confirmation",
                text: "Confirm?",
                cancelButton: "No",
                confirm: function(button) {
                  $('#quot_status').html('');
