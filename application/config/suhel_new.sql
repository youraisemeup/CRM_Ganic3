...
--
-- Host: localhost    Database: suhel_new
-- ------------------------------------------------------
...
INSERT INTO `billing_master` VALUES (6,'Fd1','Fund management','','',20,'NO','Service',1),(4,'Sus5','Samsung S8','Set','1000',19,'YES','Product',1),(5,'Sum8 ','Samsung Note 8 ','Set','1400',19,'YES','Product',1);
...
INSERT INTO `customer_master` VALUES (2,'U123','Unicorn Trading','','',0,'','','','',0.00,0,2,'','',0.0,7,NULL),(3,'U123 USD','Unicorn Trading  US Account','','',0,'','','','',0.00,0,6,'','',0.0,160,NULL),(4,'Alfa RUPPEES','Alfa Trading','101','demo, 21',452001,'1234567890','12345','demo@demo.com','Morgan',50000.00,30,1,'123','GST20157777/4',0.0,80,NULL);
...
INSERT INTO `invoice_setting` VALUES (1,1,'TOPs','19013','invoice','invoice header','cash on delivery','training invoice','modification invoice','','invoice notes'),(2,2,'INV','88888','','','C.O.D.','Topform Trg Ctr','','','All overdue accounts is chargeable for interest @ 1% per mensum');
...
INSERT INTO `quotation_master` VALUES (1,'QUOT\\TOP2017\\70002',2,2,'Based on the broad guidelines given to us, we are pleased to quote as follows : demo  text End',2,165.85,1.89,162.72,7.00,162.73,1.00,162.73,'5 days Overdue will be charged 3% of Total Payment','TRADPAC Training Centre','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','REJECTED','2017-07-21','2017-07-21',0),(3,'QUOT\\TOP2017\\70004',1,2,'Based on the broad guidelines given to us, we are pleased to quote as follows : demo  text End',2,800.00,10.00,720.00,7.00,725.60,1.00,725.60,'5 days Overdue will be charged 3% of Total Payment','TRADPAC Training Centre','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','CONFIRM','2017-07-22','2017-07-22',0),(4,'QUOT\\TOP2017\\70005',1,1,'Based on the broad guidelines given to us, we are pleased to quote as follows : demo  text End',2,0.00,0.00,0.00,7.00,0.00,1.00,0.00,'5 days Overdue will be charged 3% of Total Payment','TRADPAC Training Centre','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','CONFIRM','2017-07-22','2017-07-22',0),(6,'QUOT\\TOP2017\\70007',1,2,'Based on the broad guidelines given to us, we are pleased to quote as follows : demo  text End',1,810.00,0.00,810.00,7.00,866.70,47.14,40856.24,'5 days Overdue will be charged 3% of Total Payment','TRADPAC Training Centre','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','CONFIRM','2017-07-22','2017-08-25',0),(7,'QUOT\\TOP2017\\70008',16,2,'Based on the broad guidelines given to us, we are pleased to quote as follows : demo  text End',2,30454.00,10.00,27408.60,7.00,27621.78,1.00,27621.78,'5 days Overdue will be charged 3% of Total Payment','TRADPAC Training Centre','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','CONFIRM','2017-07-22','2017-07-23',0),(8,'QUOT\\TOP2017\\70009',1,1,'Based on the broad guidelines given to us, we are pleased to quote as follows : demo  text End',2,170.00,25.00,127.50,7.00,130.47,1.00,130.47,'5 days Overdue will be charged 3% of Total Payment','TRADPAC Training Centre','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','REJECTED','2017-07-23','2017-07-23',0),(9,'QUOT\\TOP2017\\70010',5,1,'test header',1,1200.00,20.00,960.00,7.00,976.80,0.93,907.45,'in 5 days','training center','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','PENDING','2017-08-17','2017-08-17',0),(10,'QUOT\\TOP\\70011',4,2,'Based on the broad guidelines given to us, we are pleased to quote as follows : demo  text End',2,129000.00,50.00,64500.00,7.00,69015.00,1.00,69015.00,'5 days Overdue will be charged 3% of Total Payment','TRADPAC Training Centre','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','PENDING','2017-08-25','2017-08-25',0),(11,'QUOT\\TOP\\70012',2,1,'Based on the broad guidelines given to us, we are pleased to quote as follows : demo  text End',2,4500.00,0.00,4500.00,7.00,4815.00,1.00,4815.00,'5 days Overdue will be charged 3% of Total Payment','TRADPAC Training Centre','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','PENDING','2017-08-25','2017-08-25',0),(12,'QUOT\\TOPS\\70013',5,1,'test header',1,900.00,0.00,900.00,7.00,963.00,0.93,894.63,'in 5 days','training center','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','PENDING','2017-08-25','2017-08-25',0),(13,'QUOT\\TOPS\\2001',6,2,'test header',1,900.00,0.00,900.00,7.00,963.00,47.14,45395.82,'in 5 days','training center','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','PENDING','2017-08-25','2017-08-25',0),(14,'TOP.88889',4,1,'test header',1,14400.00,20.00,11520.00,7.00,11721.60,47.14,552556.22,'in 5 days','training center','Modification subject to separate charges',NULL,'All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.','CONFIRM','2017-08-28','2017-08-28',0);
...
INSERT INTO `quotation_setting` VALUES (1,2,'TOP','20000','order_entry','Based on the broad guidelines given to us, we are pleased to quote as follows : demo  text End','5 days Overdue will be charged 3% of Total Payment','TRADPAC Training Centre','Modification subject to separate charges','','All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.'),(2,1,'TOP','88889','invoice','test header','in 5 days','training center','Modification subject to separate charges','','All discounts extended shall be valid for 7 days from offer date*  Please stamp and sign below to confirm this order.');
...
-- Dump completed on 2017-08-29 12:59:49
