 ...
 */
$config['site_title']                 = "CRM";       // Site Title, example.com
$config['admin_email']                = "parthganatra97@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'TOPFORM MANAGMENT';            // Default administrators group, use name
